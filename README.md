...
The model was trained on the Kaggle dataset **name_to_be_added** with the selected hyperparameters: 600 estimators, maximum depth of 3, learning rate of 0.005, with 5-fold stratified cross-validation.
